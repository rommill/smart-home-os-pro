...
export function getRoomIcon(roomId: number): string {
...
export interface TemperatureStyles {
  colorClass: string;
  barColor: string;
  percent: number;
}

export function getTemperatureStyles(
...
export function toggleAuthView(showLogin: boolean): void {
...
export function updateStatus(
  ...
  else statusEl.className += "bg-sky-500/10 text-sky-400 border-sky-500/20";
